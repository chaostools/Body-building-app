package `in`.curioustools.bodybuilder.screens.dashboard

import `in`.curioustools.bodybuilder.R
import `in`.curioustools.bodybuilder.databinding.LayoutEachrowDailylogBinding
import `in`.curioustools.bodybuilder.databinding.LayoutEachrowExerciseBinding
import `in`.curioustools.bodybuilder.databinding.LayoutEachrowHeaderBinding
import `in`.curioustools.bodybuilder.modal.DailyLog
import `in`.curioustools.bodybuilder.modal.Exercise
