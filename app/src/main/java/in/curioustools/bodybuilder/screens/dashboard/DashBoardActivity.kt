...
import `in`.curioustools.bodybuilder.screens.aboutme.AboutMeActivity
import `in`.curioustools.bodybuilder.screens.challangelist.ChallengesActivity
import `in`.curioustools.bodybuilder.databinding.ActivityDashboardBinding
