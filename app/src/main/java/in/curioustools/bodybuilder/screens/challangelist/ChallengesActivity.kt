package `in`.curioustools.bodybuilder.screens.challangelist

import `in`.curioustools.bodybuilder.databinding.ActivityChallangesBinding
import `in`.curioustools.bodybuilder.modal.Exercise
import `in`.curioustools.bodybuilder.screens.MyDialogues
import `in`.curioustools.bodybuilder.screens.challangelist.ChallengesAdapter.ChallengeClickListener
import `in`.curioustools.bodybuilder.screens.start_exer.StartExerciseActivity
